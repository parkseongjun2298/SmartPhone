...
public class MonAtt extends Sprite implements BoxCollidable {
    ...
    public MonAtt(float x, float y,float power) {
        super(x, y, R.dimen.fire_speed, R.mipmap.monattack);
        this.power=power;
        this.x=x;
        this.y=y;
