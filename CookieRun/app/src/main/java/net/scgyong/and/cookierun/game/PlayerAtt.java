...
public class PlayerAtt extends Sprite implements BoxCollidable {
    ...
    public PlayerAtt(float x, float y,float power) {
        super(x, y, R.dimen.fire_speed, R.mipmap.norattack);
        this.power=power;
        this.x=x;
        this.y=y;
